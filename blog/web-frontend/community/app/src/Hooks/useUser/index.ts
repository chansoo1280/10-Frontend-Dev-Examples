...
export const getUser = async (user: StoredUser | null | undefined) => {
    ...
    return await Http<APIUserGET>(ReqType.GET, "/api/userList/" + user.id, undefined, undefined).catch((e: ResMessageWithDesc) => {
        switch (e.status) {
...
export const useUser = () => {
    ...
    return { user: queryResult.data || null, updateUser, clearUser }
}
